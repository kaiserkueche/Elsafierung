...
{AN} Alsace du nord = **<font color="22c3ec">{K}</font> <font color="e7a2f8">{U}</font> <font color="bef150">{N}</font> <font color="f4e557">{İ}</font>**  
{AS} Alsace du sud = **<font color="f5a855">{M}</font> <font color="dc4444">{E}</font> <font color="97124b">{S}</font>**

{BAN} Bas-alémanique du nord = **<font color="bef150">{N}</font> <font color="f4e557">{İ}</font> <font color="f5a855">{M}</font>**  
{HA} Haute-Alsace = **<font color="dc4444">{E}</font> <font color="97124b">{S}</font>**
