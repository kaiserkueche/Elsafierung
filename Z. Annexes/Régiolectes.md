...
(voir [[İndex de cartes#⟨finde/gfunde⟩|carte finde]] et [[3. Variétés dialectales#1. Les isophones|C.1. point ⑩]])
...
(voir [[3. Variétés dialectales#1.2. La variante ⟨ä/ë⟩|C.1.2]])
...
(voir [[ala 197 gehn.png|carte gehn]], [[İnfinitif#Marquage de l’infinitif|Marquage de l’infinitif]] et [[3. Variétés dialectales#3. Résumé|C.3. point ⑧]])

#### {g} Maintien de ⟨g⟩ en toute position

Zone où l’on maintient le ⟨g⟩ /ɡ̊/ en tout position environ en {AS} à quelques communes près. (voir [[3. Variétés dialectales#1. Les isophones|C.1. point ⑥]])
...
(voir [[3. Variétés dialectales#1.3. La monophtongaison|C.1.3]])

#### {ee} Fermeture de ⟨ee, oo⟩ en /ɪː/ et /ʊː/

==description== c’est aussi la zone où on distingue les 2 : /ɪː/ et /eː/

(voir [[3. Variétés dialectales#1.7. Prononciation de ⟨ee⟩ et ⟨oo⟩|C.1.7]])
