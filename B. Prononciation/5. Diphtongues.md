...
La variante **\[ɪː]** de ⟨ie⟩ est similaire à ⟨ee/eh⟩ pour la zone [[{ee}]] dans la [[4. Voyelles#3.2 Prononciation équivalente en français|B.4 /ɪ, ɪː/]] : il s’agit du même son intermédiaire entre le ⟨i⟩ et ⟨é⟩ français. Généralement, les parlers ayant /ɪː/ pour ⟨ee⟩ auront une autre prononciation pour ⟨ie⟩ afin de maintenir la distinction, mais il se peut que les deux se prononcent pareil, dans quel cas seul l’orthographe pourra distinguer *Leeb* de *Lieb.* 
